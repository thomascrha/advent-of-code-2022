...
def calculate_score(
    directory_sizes, used_space, total_space=70000000, unused_space_target=30000000
):
    unused_space = total_space - used_space
    target = unused_space_target - unused_space
    candidates = []
...
directory_sizes[0]["/"] = directory_tree["/"]["_size"]
# print(directory_sizes)
calculate_score(directory_sizes, directory_tree["/"]["_size"])
